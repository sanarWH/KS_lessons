...
fun main(){
    ...
    println("Груз с весом: $cargoWeight1; и объемом: $cargoVolume1; соответствует категории Average: " +
            "${cargoWeight1 >= AVERAGE_WEIGHT_MIN && cargoWeight1 <= AVERAGE_WEIGHT_MAX && cargoVolume1 < AVERAGE_VOLUME}")

    println("Груз с весом: $cargoWeight2; и объемом: $cargoVolume2; соответствует категории Average: " +
            "${cargoWeight2 >= AVERAGE_WEIGHT_MIN && cargoWeight2 <= AVERAGE_WEIGHT_MAX && cargoVolume2 < AVERAGE_VOLUME}")
}
